 ...
 */
package com.orchestral.automation.dryselmagic.demo;

import org.junit.runner.RunWith;

import com.orchestral.automation.dryselmagic.MagicTestRunner;
import com.orchestral.automation.dryselmagic.model.annotations.MagicTestOptions;

@RunWith(MagicTestRunner.class)
@MagicTestOptions(pathOfTestDescriptions = "src/test/resources/testDescriptions", pathOfTestObjects = "src/test/resources/testObjects")
public class MagicTestRunnerTest {
}
